...
| **N24** | Kết quả player + điều hướng cuối trận | ▶️ **Tiếp theo** | Ưu tiên hiện tại |
| N25 | E2E classic nhiều máy | ⏳ Sau N24 | Chốt M4 |
...
**Critical path hiện tại:** `N24 → N25/M4`. N20.6 là nhánh blocked, không được giữ critical path. N31–N33 là tham chiếu phạm vi cũ, không phải ba mốc cần làm lại.
...
- [ ] **N24 — TIẾP THEO**: `leaderboard:updated` + `answer:received` (không lộ đúng/sai); hoàn thiện kết quả giữa câu; xử lý `game:ended` và điều hướng sang `Route.FinalResult`/màn kết quả cuối trận.

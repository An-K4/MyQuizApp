...
| **N25** | E2E classic nhiều máy | ▶️ **Tiếp theo** | Chốt M4 |
...
**Critical path hiện tại:** `N25/M4`. N20.6 là nhánh blocked, không được giữ critical path. N31–N33 là tham chiếu phạm vi cũ, không phải ba mốc cần làm lại.
...
- [ ] **N25 — TIẾP THEO**: E2E classic với host + ít nhất 2 Player Android thật; kiểm tra reconnect, ACK uncertainty, config reveal/leaderboard và chốt M4.
